...
- Pkg folder: [packages\webhook-outbox](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\webhook-outbox)
...
graph LR
  ...
  webhook_outbox["webhook_outbox"]:::center
```
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package webhook-outbox -Apply
