...
| Pkg folder | [packages\webhook-outbox](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/webhook-outbox) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package webhook-outbox -Apply
