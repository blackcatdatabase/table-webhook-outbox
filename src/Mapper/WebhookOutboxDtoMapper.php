...
namespace BlackCat\Database\Packages\WebhookOutbox\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO WebhookOutboxDto:
 ...
 */
final class WebhookOutboxDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'event_type' => 'eventType', 'payload' => 'payload', 'status' => 'status', 'retries' => 'retries', 'next_attempt_at' => 'nextAttemptAt', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt', 'version' => 'version' ];
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'next_attempt_at', 'created_at', 'updated_at' ];
    /** @var string[] */
     ...
     * @return WebhookOutboxDto
     */
    public static function fromRow(array $row): WebhookOutboxDto
    {
        /** @var WebhookOutboxDto */
        return DtoHydrator::fromRow(
            WebhookOutboxDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?WebhookOutboxDto
    {
     ...
     *
     * @param WebhookOutboxDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(WebhookOutboxDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(WebhookOutboxDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(WebhookOutboxDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,WebhookOutboxDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,WebhookOutboxDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(WebhookOutboxDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,WebhookOutboxDto>
     */
