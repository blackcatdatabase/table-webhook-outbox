...
use BlackCat\Database\Packages\WebhookOutbox\Repository\WebhookOutboxRepositoryInterface;
use BlackCat\Database\Packages\WebhookOutbox\Repository\WebhookOutboxRepository as GeneratedRepository;
...
{
  private WebhookOutboxRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof WebhookOutboxRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected WebhookOutboxRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\WebhookOutbox\Dto\WebhookOutboxDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\WebhookOutbox\Dto\WebhookOutboxDto|null { return $this->repo->getById($id, $asDto); }
