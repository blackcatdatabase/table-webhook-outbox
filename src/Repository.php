...
{
    private WebhookOutboxRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new WebhookOutboxRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\WebhookOutbox\Dto\WebhookOutboxDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\WebhookOutbox\Dto\WebhookOutboxDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\WebhookOutbox\Dto\WebhookOutboxDto|null
    {
