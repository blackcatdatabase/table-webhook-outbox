...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'event_type', 'payload', 'status', 'retries', 'next_attempt_at', 'created_at', 'updated_at', 'version' ];
    }
    ...
    {
        $x = [ 'id', 'event_type', 'status', 'retries', 'next_attempt_at', 'created_at', 'updated_at', 'version' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\WebhookOutbox\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\WebhookOutbox\Definitions::softDeleteColumn();
