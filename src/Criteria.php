 ...
 * - whitelist filtrů: [ 'id', 'event_type', 'payload', 'status', 'retries', 'next_attempt_at', 'created_at', 'updated_at', 'version' ]
 * - whitelist LIKE:   [ 'event_type', 'status' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'event_type', 'payload', 'status', 'retries', 'next_attempt_at', 'created_at', 'updated_at', 'version' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'event_type', 'payload', 'status', 'retries', 'next_attempt_at', 'created_at', 'updated_at', 'version' ], true);
            $parts = [];
